...
namespace Factories
{
    public class TurbineEngineFactory
    {
        ...
        public Turbofan MakeTurbofan(float bypassratio, uint numberofshafts, Generator generator, List<Spool> spools, int egt, int isp,
            ...
            bool hasreverse = true, string parentvehicleID = null)
        {
            ...
            return new Turbofan(bypassratio, isgeared, hasreverse, numberofshafts, generator, spools, egt, isp,
                numberofcycles, fueList, oxidisers,
                manuf, model, serialnumber, maxpower, operatingtime, parentvehicleID, fuelflow, stat);
        }

        public bool TryMakeTurbofan(float bypassratio, uint numberofshafts, Generator generator, List<Spool> spools, int egt, int isp,
            int numberofcycles, List<Propellants> fueList, List<Oxidisers> oxidisers, string manuf, string model,
            ...
            bool hasreverse = true, string parentvehicleID = null)
        {
            try
            {
                Turbofan turbofan = MakeTurbofan(bypassratio, numberofshafts, generator, spools, egt, isp,
        ...
        public Turbofan TryMakeTurbofan(float bypassratio, uint numberofshafts, Generator generator, List<Spool> spools, int egt, int isp,
            int numberofcycles, List<Propellants> fueList, List<Oxidisers> oxidisers, string manuf, string model,
            string serialnumber,float maxpower, float operatingtime, float fuelflow, OnOff stat,bool isgeared = false,
            bool hasreverse = true, string parentvehicleID = null)
        {
            ...
            try
            {
                turbofan = MakeTurbofan(bypassratio, numberofshafts, generator, spools, egt, isp,
                    numberofcycles, fueList,
                    oxidisers, manuf, model, serialnumber, maxpower, operatingtime, fuelflow, stat, isgeared, hasreverse,
                    parentvehicleID);
            }
            catch (ArgumentNullException argumentNullException)
            {
                ...
                switch (argumentNullException.ParamName)
                {
                    case nameof(spools):
                        ...
                        TryMakeTurbofan(bypassratio, numberofshafts, generator, spools, egt, isp,
                            numberofcycles, fueList,
        ...
        public Turboshaft MakeTurboshaft(float gearingR, float maxtorque, uint numberofshafts, Generator generator,
            ...
            float operatingtime, float fuelflow, OnOff stat, bool hasreverse = true, string parentvehicleID = null)
        {
            ...
            return new Turboshaft(gearingR, maxtorque, hasreverse, numberofshafts, generator, spools, egt, isp,
                numberofcycles, fueList,
        ...
        public Turboshaft TryMakeTurboshaft(float gearingR, float maxtorque, uint numberofshafts, Generator generator,
            List<Spool> spools, int egt, int isp, int numberofcycles, List<Propellants> fueList,
            List<Oxidisers> oxidisers, string manuf, string model, string serialnumber, float maxpower,
            ...
            string parentvehicleID = null)
        {
            ...
            try
            {
                turboshaft = MakeTurboshaft(gearingR, maxtorque, numberofshafts, generator, spools, egt, isp,
                    numberofcycles, fueList,
                    oxidisers, manuf, model, serialnumber, maxpower, operatingtime, fuelflow, stat, hasreverse,
                    parentvehicleID);
                return turboshaft;
            ...
            catch (ArgumentNullException argumentNullException)
            {
                ...
                switch (argumentNullException.ParamName)
                {
                    case nameof(spools):
                        spools = new List<Spool>();
                        turboshaft = TryMakeTurboshaft(gearingR, maxtorque, numberofshafts, generator, spools, egt, isp,
                            numberofcycles, fueList,
                            oxidisers, manuf, model, serialnumber, maxpower, operatingtime, fuelflow, stat, hasreverse,
                            parentvehicleID);
                        break;
        ...
        public Turbojet MakeTurbojet(uint numberofshafts, Generator generator, List<Spool> spools, int egt, int isp, int numberofcycles,
                                            List<Propellants> fueList, List<Oxidisers> oxidisers, string manuf, string model, string serialnumber, float maxpower,
                                            float operatingtime, float fuelflow, OnOff stat, bool hasreverse = true, string parentvehicleID = null)
        {
            GeneralConditionsChecker(numberofshafts, spools, fueList, oxidisers, serialnumber);

            return new Turbojet(hasreverse, numberofshafts, generator, spools, egt, isp,
                numberofcycles, fueList,
                oxidisers, manuf, model, serialnumber, maxpower, operatingtime, parentvehicleID, fuelflow, stat);
        }

        public bool TryMakeTurbojet(uint numberofshafts, List<Spool> spools, Generator generator,
            ...
            float operatingtime, float fuelflow, OnOff stat, out Turbojet incomingTurbojet, bool hasreverse = true, string parentvehicleID = null)
        {
            try
            {
                Turbojet turbojet = MakeTurbojet(numberofshafts, generator, spools, egt, isp,
                    numberofcycles, fueList,
                    oxidisers, manuf, model, serialnumber, maxpower, operatingtime, fuelflow, stat, hasreverse,
                    parentvehicleID);
        ...
        public Turbojet TryMakeTurbojet(uint numberofshafts, Generator generator, List<Spool> spools, 
            int egt, int isp, int numberofcycles,
            List<Propellants> fueList, List<Oxidisers> oxidisers, string manuf, string model, string serialnumber,
            float maxpower,
            float operatingtime, float fuelflow, OnOff stat, bool hasreverse = true, string parentvehicleID = null)
        {
            ...
            try
            {
                turbojet = MakeTurbojet(numberofshafts, generator, spools, egt, isp,
                    numberofcycles, fueList,
                    oxidisers, manuf, model, serialnumber, maxpower, operatingtime, fuelflow, stat, hasreverse,
                    parentvehicleID);
            }
            catch (ArgumentNullException argumentNullException)
            {
                ...
                switch (argumentNullException.ParamName)
                {
                    case nameof(spools):
                        spools = new List<Spool>();
                        turbojet = TryMakeTurbojet(numberofshafts, generator, spools, egt, isp,
                            numberofcycles, fueList,
                            oxidisers, manuf, model, serialnumber, maxpower, operatingtime, fuelflow, stat, hasreverse,
                            parentvehicleID);
                        break;
